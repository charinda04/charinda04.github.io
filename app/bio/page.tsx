      ...
      <main className="max-w-4xl mx-auto px-6 py-12 space-minimal-lg">
        ...
        <div className="text-center space-minimal">
          ...
          <p className="text-theme-base text-theme-text-secondary max-w-xl mx-auto leading-relaxed">
            Get to know the person behind the code - my journey, values, and
            what drives me to create meaningful digital experiences.
          </p>
        </div>

        {/* Personal Introduction */}
        <Card className="border-theme-border bg-theme-card-bg shadow-minimal">
          <CardContent className="pt-6 space-minimal-sm">
            <h2 className="text-theme-2xl font-medium text-theme-text mb-4">
              Hello, I'm Charinda! 👋
            </h2>
            <div className="space-y-4 text-theme-sm text-theme-text-secondary leading-relaxed">
              <p>
                I'm a passionate software engineer from Sri Lanka with over 8
                years of experience in building web and mobile applications. My
                journey started with a curiosity about how websites work, and it
                has evolved into a deep love for creating digital solutions that
                make a real difference in people's lives.
              </p>
              <p>
                When I'm not coding, you'll find me exploring new technologies,
                contributing to open source projects, or sharing knowledge
                through technical blogs and community meetups. I believe that
                the best way to grow as a developer is to stay curious, keep
                learning, and give back to the community that has given me so
                much.
              </p>
              <p>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-4">
            <Card className="border-theme-border bg-theme-card-bg shadow-minimal">
              <CardContent className="pt-6 text-center space-y-2">
                ...
                <h3 className="text-theme-sm font-medium text-theme-text">
                  Location
                </h3>
        ...
        <section className="space-minimal">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            {INTERESTS.map((interest, index) => (
              ...
              >
                <CardContent className="pt-6">
                  <h3 className="text-theme-lg font-medium text-theme-text mb-4">
                    {interest.category}
                  </h3>
